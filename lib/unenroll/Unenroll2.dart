...
class Unenroll2 extends StatefulWidget {
  const Unenroll2({Key? key}) : super(key: key);

  @override
  _Unenroll2State createState() => _Unenroll2State();
}
...
class _Unenroll2State extends State<Unenroll2> {
                        ...
                        children: [
                          ...
                          InkWell(
                              onTap: () async {
                                ...
                                unenrollCourse('Web Development');
