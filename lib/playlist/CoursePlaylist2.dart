...
class CoursePlaylist2 extends StatefulWidget {
  const CoursePlaylist2({Key? key}) : super(key: key);

  @override
  _CoursePlaylist2State createState() => _CoursePlaylist2State();
}
...
class _CoursePlaylist2State extends State<CoursePlaylist2> {
                          ...
                          InkWell(
                              onTap: () {
                                ScaffoldMessenger.of(context)
                                  ...
                                  content:
                                      Text('Web Dev was added to your cart'),
                                ));
                              },
                              child: Ink(
                                  child: Container(
