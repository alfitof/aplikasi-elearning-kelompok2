...
class CoursePlaylist1 extends StatefulWidget {
  const CoursePlaylist1({Key? key}) : super(key: key);

  @override
  _CoursePlaylist1State createState() => _CoursePlaylist1State();
}
...
class _CoursePlaylist1State extends State<CoursePlaylist1> {
