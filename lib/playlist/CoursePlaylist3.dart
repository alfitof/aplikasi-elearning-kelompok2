...
class CoursePlaylist3 extends StatefulWidget {
  const CoursePlaylist3({Key? key}) : super(key: key);

  @override
  _CoursePlaylist3State createState() => _CoursePlaylist3State();
}
...
class _CoursePlaylist3State extends State<CoursePlaylist3> {
                          ...
                          InkWell(
                              onTap: () {
                                ScaffoldMessenger.of(context)
                                  ...
                                  content: Text(
                                      'Data Analyst was added to your cart'),
                                ));
                              },
                              child: Ink(
                                  child: Container(
